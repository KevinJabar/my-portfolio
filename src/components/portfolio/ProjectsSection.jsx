...
const projects = [
  ...
  },
  {
    ...
    result: "View Project",
    url: "https://industrial-relation.com",
    image: "project-2.png",
  },
  {
    number: "03",
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {projects.map((project, i) => (
            <motion.article
              ...
              className="bg-white rounded-2xl border border-border overflow-hidden hover:shadow-md transition-shadow duration-300 flex flex-col"
            >
              ...
              <div className="p-5 flex flex-col flex-1">
                ...
                <a href={project.url} target="_blank" rel="noopener noreferrer" className="mt-auto inline-flex items-center gap-2 text-sm font-medium text-primary">
                  Live Demo
                  <span>↗</span>
                </a>
              </div>
